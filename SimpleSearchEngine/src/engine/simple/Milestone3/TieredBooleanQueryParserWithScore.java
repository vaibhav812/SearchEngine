...
/**
 * A query parser for Boolean queries integrated with tiered index and scores.
 * @author vaibhavjain
 * @version 1.0
 */
public class TieredBooleanQueryParserWithScore {
	...
	public TieredBooleanQueryParserWithScore(String path) {
		index = new TieredDiskInvertedIndexWithScore(path);
	}
	
	public TieredBooleanQueryParserWithScore(TieredDiskInvertedIndexWithScore index) {
		this.index = index;
	}
