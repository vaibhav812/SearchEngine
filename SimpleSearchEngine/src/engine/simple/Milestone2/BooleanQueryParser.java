...
/**
 * A query parser for Boolean queries.
 * @author vaibhavjain
 * @version 1.1
 */
public class BooleanQueryParser {
	...
	public BooleanQueryParser(String path) {
		index = new DiskInvertedIndex(path);
	}
	
	public BooleanQueryParser(DiskInvertedIndex index) {
		this.index = index;
	}
